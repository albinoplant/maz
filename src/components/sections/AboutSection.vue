...
<template>
  <section
    id="about"
    class="border-y border-stone-200 bg-stone-100 py-24 md:py-32"
    aria-labelledby="about-heading"
  >
    <div class="mx-auto grid max-w-7xl items-center gap-12 px-6 md:grid-cols-2 md:gap-16 md:px-10">
